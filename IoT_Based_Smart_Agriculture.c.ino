...
String apiKey = "C25ICK6FHOR7PST4";     // MUST Enter your Write API key from ThingSpeak
const char *ssid = "MySmartHome";      // MUST replace with your wifi ssid and wpa2 key
const char *pass = "nRF52840";
const char* server = "api.thingspeak.com"; //MUST replace your server OR you can creat your account in thingspeak.com
